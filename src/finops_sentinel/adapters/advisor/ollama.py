...
_SYSTEM_PROMPT = (
    ...
    "- Always name the AWS region in the summary. The same account is scanned "
    "across many regions and the same finding shape recurs in each, so an "
    "approver cannot tell them apart without it.\n"
